...
def main():
    ...
    if selected_podcast:
        ...
        st.header("Newsletter Content", anchor="content")
        ...
        with col1:
            ...
            st.markdown(podcast_info['podcast_summary'], unsafe_allow_html=True)
        ...
        with col4:
            ...
            st.markdown(podcast_info["podcast_guest"]['summary'], unsafe_allow_html=True)
